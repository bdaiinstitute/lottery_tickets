...
from franka_sim.jaxish.controllers import opspace
...
class PandaPickCubeGymEnv(MujocoGymEnv):
    ...
    def render(self) -> list[np.ndarray]:
        # TODO: Should we concat images before returning?
    ...
    #     """Copied from tianshou version"""
    #     rendered_frames = []
    #     for cam_id in self.camera_id:
    #         rendered_frames.append(
    #             self._viewer.render(
    #                 render_mode=self.render_mode, camera_id=cam_id
    #             ).copy()  # copy due to flipud in render
    #         )
