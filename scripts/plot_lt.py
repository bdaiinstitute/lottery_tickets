...
data = {
    ...
    "Libero": {
        ...
        "Golden Ticket": [
            np.mean([84, 98, 92, 100, 92, 90, 100, 96, 90, 92]),  # spatial
            np.mean([100, 100, 100, 68, 100, 100, 94, 100, 100, 82]),  # goal
            np.mean([100, 100, 100, 100, 100, 100, 100, 100, 100]),  # object
        ],
    },
    "DexMimicGen": {
...
data_std = {
    ...
    "Libero": {
        ...
        "Golden Ticket": [
            np.std([84, 98, 92, 100, 92, 90, 100, 96, 90, 92]),  # spatial
            np.std([100, 100, 100, 68, 100, 100, 94, 100, 100, 82]),  # goal
            np.std([100, 100, 100, 100, 100, 100, 100, 100, 100]),  # object
        ],
    },
    "DexMimicGen": {
